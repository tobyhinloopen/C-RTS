...
#ifdef CONFIG_SCALABLE_GRID_ENABLED
const float PROJECTILE_MAX_IMPACT_DISTANCE = PROJECTILE_FACTORY_IMPACT_DISTANCE > PROJECTILE_UNIT_IMPACT_DISTANCE
  ? PROJECTILE_FACTORY_IMPACT_DISTANCE : PROJECTILE_UNIT_IMPACT_DISTANCE;

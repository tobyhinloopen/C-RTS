...
// #define CONFIG_BKTREE_ENABLED

// #define BKTREE_TO_SCALAR(x) ((int)(x + 512))
...
#define SIZE_Y 4096
#define TEAM_COUNT 5
#define FACTORY_ROWS 4
#define FACTORY_COLS 10
#define SPAWN_POINTS_COUNT ((TEAM_COUNT - 1) * FACTORY_ROWS * FACTORY_COLS)

#define BENCHMARK_INTERVAL_MS 0x0000F
#define BENCHMARK_DURATION_MS 0x03FFF
